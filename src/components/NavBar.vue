    ...
    <nav class="bg-coolGray-900">
        <div class="container flex items-center justify-between mx-auto">
            ...
            <div class="flex items-centerspace-x-4"> 
                ...
                <div v-else>
                    <button @click="signIn"
                    class="px-8 py-2 font-semibold bg-green-600 rounded-full focus:ring-green-900 focus:ring-4 focus:outline-none text-coolGray-100 hover:bg-green-800">Login</button>
                </div>
            </div>
        </div>
    </nav>
